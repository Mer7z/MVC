...
from vista.CrearUsuario import CrearUsuario
from vista.ModificarUsuario import ModificarUsuario
from vista.EliminarUsuario import EliminarUsuario
...
class ConsultarUsuarios():
    ...
    def __init__(self, loggin, usuario):
        ...
        self.btnModificarUsuario.place(relx=0.5, x=50, y=25, anchor="ne")
